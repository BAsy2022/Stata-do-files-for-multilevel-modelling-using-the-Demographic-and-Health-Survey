...
use "/Volumes/BOA/DHS SSA/NI_2012_DHS_01272019_1923_129249/NIIR61DT/NIIR61FL.DTA"
...
gen A_h = 0
*Urban
replace A_h = 109  if v022 == 1 
replace A_h = 31  if v022 == 3 
replace A_h = 80 if v022 == 6 
replace A_h = 137 if v022 == 8 
replace A_h = 124  if v022 == 11
replace A_h = 55 if v022 == 14 
replace A_h = 159 if v022 == 16 
replace A_h = 369 if v022 == 19
*Rural sedentary 
replace A_h = 205 if v022 == 4 
replace A_h = 1051 if v022 == 7 
replace A_h = 1359 if v022 == 9 
replace A_h = 1244 if v022 == 12 
replace A_h = 1253 if v022 == 15 
replace A_h = 1400 if v022 == 17 
*Rural nomad
replace A_h = 233 if v022 == 2 
replace A_h = 14 if v022 == 5 
replace A_h = 16 if v022 == 10 
replace A_h = 114 if v022 == 13 
replace A_h = 54 if v022 == 18

*********STEP 3******
* M_h average number of households per cluster by strata (Table A.3 of the DHS report_Page 354) 
gen M_h = 0 
*Urban
replace M_h = 224  if v022 == 1 
replace M_h = 289  if v022 == 3 
replace M_h = 228 if v022 == 6 
replace M_h = 276 if v022 == 8 
replace M_h = 257 if v022 == 11 
replace M_h = 215 if v022 == 14 
replace M_h = 273 if v022 == 16 
replace M_h = 298 if v022 == 19 
*Rural sedentary 
replace M_h = 250 if v022 == 4 
replace M_h = 165 if v022 == 7 
replace M_h = 190 if v022 == 9 
replace M_h = 208 if v022 == 12 
replace M_h = 172 if v022 == 15 
replace M_h = 221 if v022 == 17 
*Rural nomad
replace M_h = 115 if v022 == 2 
replace M_h = 313 if v022 == 5 
replace M_h = 199 if v022 == 10 
replace M_h = 240 if v022 == 13 
replace M_h = 175 if v022 == 18
*********STEP 4******
